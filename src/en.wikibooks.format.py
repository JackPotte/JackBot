...
def main(*args):
    if len(sys.argv) > 1:
        ...
        if sys.argv[1] == u'-test':
            ...
            p.pagesByCat(u'Pages using RFC magic links', afterPage = afterPage)
            #p.pagesByCat(u'Category:Pages using ISBN magic links', afterPage = afterPage)
            #p.pagesByCat(u'Category:Pages with ISBN errors', afterPage = afterPage)

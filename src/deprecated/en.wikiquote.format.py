...
# coding: utf-8
"""
This script formats the Wikiquote pages
"""
...
def treat_page_by_name(page_name):
    ...
    if current_page_content == 'KO' or page_name.find('/print version') != -1:
        return
...
def main(*args):
    if len(sys.argv) > 1:
        ...
        if sys.argv[1] == '-test':
            ...
            p.pages_by_cat('Category:Pages using ISBN magic links', namespaces = None, afterPage = afterPage)

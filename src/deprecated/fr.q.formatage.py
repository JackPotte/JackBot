...
import os, catlib, pagegenerators, re, hyperlynx
...
summary = u'[[Modèle:lien brisé|Vérification des liens externes]]'
debogage = False
...
def log(source):		
	txtfile = codecs.open(u'_WQ.log', 'a', 'utf-8')
...
def sauvegarde(PageCourante, Contenu, Resume):
	try:
		...
		if PageCourante.title() != u'Utilisateur:JackBot/test': ArretDUrgence()
...
# Lancement :
TraitementTout = crawlerAll(u'Affaire Seznec')
'''
#Modeles :

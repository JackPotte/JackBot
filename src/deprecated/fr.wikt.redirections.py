...
import html2Unicode		# Faits maison
...
debogage = False
debogageLent = False
input = u'articles_WTin.txt'
output = u'articles_WTout.txt'
ns = 0

# Modification du wiki
def modification(PageHS):
	print(PageHS.encode(config.console_encoding, 'replace'))
	summary = u'[[Aide:Redirections|Redirection pour apostrophe]]'
...
def crawlerFile(source):
	if source:
		...
		while 1:
			...
			modification(html2Unicode.html2Unicode(PageHS.replace(u'\n',u'')))
		PagesHS.close()

...
newportail[1] = u'Flandre-Occidentale'
newportail[2] = u''
newportail[3] = u''
newportail[4] = u''
newportail[5] = u''
notportail[1] = u'flandre-occidentale'	# [[Wikipédia:Règle_sur_l'apposition_de_liens_vers_les_portails]]
notportail[2] = u'Belgique'
notportail[3] = u'belgique'
notportail[4] = u'Flandre'
notportail[5] = u'flandre'
if newportail[1] != "":
...
TraitementCategory = crawlerCat(u'catégorie:Commune avant fusion de la province de Flandre-Occidentale')
'''
TraitementCategory = crawlerCat(u'catégorie:Province de Flandre-Occidentale')
TraitementCategory = crawlerCat(u'catégorie:Sport dans la province de Flandre-Occidentale')
TraitementCategory = crawlerCat(u'catégorie:Tournoi de Knokke-Heist')
TraitementCategory = crawlerCat(u'catégorie:Sport à Bruges')
TraitementCategory = crawlerCat(u'catégorie:FC Bruges')
TraitementCategory = crawlerCat(u'catégorie:Ville de la province de Flandre-Occidentale')
TraitementCategory = crawlerCat(u'catégorie:Bruges')
TraitementCategory = crawlerCat(u'catégorie:Commune de la province de Flandre-Occidentale')
TraitementCategory = crawlerCat(u'catégorie:Bâtiment à Courtrai')
TraitementCategory = crawlerCat(u'catégorie:Courtrai')
TraitementCategory = crawlerCat(u'catégorie:Ostende')
'''
raw_input("Jackpot")

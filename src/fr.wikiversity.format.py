...
if len(sys.argv) > 1:
	...
	if sys.argv[1] == u'test':
		...
		crawlerLink(u'Recherche:Licence Pro ECPI Lille',u'')
		crawlerLink(u'Recherche:Bilan Carbone(r)',u'')
	elif sys.argv[1] == u'm':
		crawlerLink(u'Modèle:Idfaculté/logo/langues étrangères',u'')
	elif sys.argv[1] == u'cat':
		crawlerCat(u'Catégorie:JavaScript', False, u'', doc = False)
	elif sys.argv[1] == u'page':
		modification(u'Utilisateur:JackBot/test unitaire')
	elif sys.argv[1] == u'p':
		modification(u'Modèle:Page personnelle/Documentation')
	else:

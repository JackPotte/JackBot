...
def html2Unicode(PageHS):
	...
	PageHS = PageHS.replace(u'&#7843;', u'ả')
	PageHS = PageHS.replace(u'&#7841;', u'ạ')
	PageHS = PageHS.replace(u'&#7853;', u'ậ')
	PageHS = PageHS.replace(u'&#7849;', u'ẩ')
	PageHS = PageHS.replace(u'&#7863;', u'ặ')
	PageHS = PageHS.replace(u'&#7845;', u'ấ')
	PageHS = PageHS.replace(u'&#7859;', u'ẳ')
	PageHS = PageHS.replace(u'&#7857;', u'ằ')
	...
	PageHS = PageHS.replace(u'&#7865;', u'ẹ')
	PageHS = PageHS.replace(u'&#7879;', u'ệ')
	PageHS = PageHS.replace(u'&#7873;', u'ề')
	PageHS = PageHS.replace(u'&#7875;', u'ể')
	PageHS = PageHS.replace(u'&#7871;', u'ế')
	PageHS = PageHS.replace(u'&#7877;', u'ễ')
	...
	PageHS = PageHS.replace(u'&#7883;', u'ị')
	PageHS = PageHS.replace(u'&#297;', u'ĩ')
	PageHS = PageHS.replace(u'&#236;', u'ì')
	PageHS = PageHS.replace(u'&#7881;', u'ỉ')
	...
	PageHS = PageHS.replace(u'&#417;', u'ơ')
	PageHS = PageHS.replace(u'&#7903;', u'ở')
	PageHS = PageHS.replace(u'&#7897;', u'ộ')
	PageHS = PageHS.replace(u'&#7889;', u'ố')
	PageHS = PageHS.replace(u'&#7891;', u'ồ')
	PageHS = PageHS.replace(u'&#7905;', u'ỡ')
	PageHS = PageHS.replace(u'&#7899;', u'ớ')
	PageHS = PageHS.replace(u'&#7907;', u'ợ')
	PageHS = PageHS.replace(u'&#7893;', u'ổ')
	PageHS = PageHS.replace(u'&#7901;', u'ờ')
	PageHS = PageHS.replace(u'&#7885;', u'ọ')
	PageHS = PageHS.replace(u'&#7887;', u'ỏ')
	PageHS = PageHS.replace(u'&#7895;', u'ỗ')
	...
	PageHS = PageHS.replace(u'&#432;', u'ư')
	PageHS = PageHS.replace(u'&#7913;', u'ứ')
	PageHS = PageHS.replace(u'&#251;', u'û')
	PageHS = PageHS.replace(u'&#252;', u'ü')
	PageHS = PageHS.replace(u'&#365;', u'ŭ')
	PageHS = PageHS.replace(u'&#7911;', u'ủ')
	PageHS = PageHS.replace(u'&#7917;', u'ử')
	PageHS = PageHS.replace(u'&#7915;', u'ừ')
	...
	PageHS = PageHS.replace(u'&#322;', u'ł')
	PageHS = PageHS.replace(u'&#382;', u'ž')
	PageHS = PageHS.replace(u'&#10102;', u'❶')
	return PageHS

    ...
    if Page != '' and CodeLangue != '' and Section != '' and Contenu != '':
        if Page.find(Contenu) == -1 and Page.find(u'{{langue|' + CodeLangue + u'}}') != -1:
            ...
            if len(SectionPage[o]) > 0:
                ...
                if debugLevel > 0: print u' sections de la page :'
                while o < len(SectionPage) and SectionPage[o][0] != u'langue' and numeroSection(SectionPage[o][0]) <= NumSection:
                    if debugLevel > 0: print u'  ' + SectionPage[o][0] + u'  ' + str(numeroSection(SectionPage[o][0]))
                    o = o + 1
                o = o - 1
                ...
                if PageTemp3.find(u'\n==') == -1:
                    ...
                    if debugLevel > 0: print u' ajout avant pochaine langue'
...
if len(sys.argv) > 1:
    ...
    if sys.argv[1] == u'test':
        ...
        modification(u'File:De-Dominikanische Republik.ogg')
    elif sys.argv[1] == u'cat':
        crawlerCat2(u'Category:Pronunciation‎', True, u'')
        ...
        crawlerSearch(u'File:fr-Paris--')    # à faire : renommer les "File:Fr-œsophagienne-fr FR-Paris.ogg" avec "{{rename|Fr-Paris--œsophagienne.ogg|4|Pronunciation norm for Wiktionaries sync}}"
    elif sys.argv[1] == u'u':
...
'''
    crawlerCat2(u'Category:U.S. English pronunciation‎', True, u'')
    crawlerCat2(u'Category:German pronunciation‎', True, u'')
    crawlerCat2(u'Category:Arabic pronunciation‎', True, u'')
    crawlerCat2(u'Category:Armenian pronunciation‎‎', True, u'')
    crawlerCat2(u'Category:Belarusian pronunciation‎‎‎', True, u'')
    crawlerCat2(u'Category:Chinese pronunciation‎‎‎‎', True, u'')
    crawlerCat2(u'Category:Czech pronunciation‎', True, u'')
    crawlerCat2(u'Category:Hungarian pronunciation‎‎', True, u'')
    crawlerCat2(u'Category:Swedish pronunciation‎‎‎', True, u'')
    crawlerCat2(u'Category:Ukrainian pronunciation‎', True, u'')
    crawlerCat2(u'Category:Russian pronunciation‎', True, u'')
    crawlerCat2(u'Category:Polish pronunciation‎‎', True, u'')
    crawlerCat2(u'Category:Dutch pronunciation‎‎‎‎‎', True, u'')
    crawlerCat2(u'Category:French pronunciation‎', True, u'')
    crawlerCat2(u'Category:Spanish pronunciation‎', True, u'')
    crawlerCat2(u'Category:English pronunciation‎', True, u'')
    crawlerCat2(u'Category:British English pronunciation‎', True, u'')

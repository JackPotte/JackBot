...
def addTemplates(pageContent, summary):
    ...
    regex = ur'{{Ouvrage\|prénom1=Jean\-Paul\|nom1=Savignac\|titre=Dictionnaire français\-gaulois\|éditeur=La Différence\|année=2004\|passage=([^\|{}\n]*)\|isbn=978\-2729115296}}'
    ...
    regex = ur'{{Ouvrage\|prénom1=Xavier\|nom1=Delamarre\|titre=Index de J\. Whatmough, The Dialects of Ancient Gaul\|éditeur=\|année=2004\|passage=([^\|{}\n]*)\|isbn=}}'
    ...
    regex = ur'Pierre Gastal, \'\'Nos racines celtiques, du gaulois au français\'\',? \(?éditions? [Dd]ésiris(?: 2013)?\)?, *(?:2013)?,? *pages? ([^\|{}\n]*)\.?'
    pageContent = re.sub(regex, ur'{{R:Gastal|p=\1}}', pageContent)
    ...
    regex = ur'{{Ouvrage\|langue=en\|prénom1=Desmond C\.\|nom1=Derbyshire\|prénom2=Geoffrey K\. \|nom2=Pullum\|prénom3=Daniel L\.\|nom3=Everett\|titre=Handbook of Amazonian Languages\|volume=1\|éditeur=Walter de Gruyter\|année=1986\|pages totales=646\|passage=([^\|{}\n]*)\|isbn=9783110102574}}'
    pageContent = re.sub(regex, ur'{{R:HoAL1|p=\1}}', pageContent)
    regex = ur'{{Ouvrage\|langue=pt\|prénom1=Daniel L\.\|nom1=Everett\|titre=A lingua pirahã et a teoria da sintaxe\|url=https://daneverettbooks\.com//wp\-content/uploads/2014/04/everett_90_A\-Lingua\-Pirah\.pdf\|passage=([^\|{}\n]*)\|pages totales=431\|année=1983\|éditeur=Unicamp}}'

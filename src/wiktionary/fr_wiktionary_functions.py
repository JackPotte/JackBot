...
def replace_title_templates(page_content):
    if debug_level > 0:
...
def treat_verb_inflexion(page_content, final_page_content, summary, current_page_content):
    ...
    final_page_content = final_page_content + \
        page_content[:page_content.find('\n')+1]
    page_content = page_content[page_content.find('\n')+1:]
    return page_content, final_page_content, summary, infinitive
...
def add_languages_codes_to_each_template(
        page_content,
        summary,
        page_name,
        final_page_content,
    ...
    while start_position > -1:
        ...
        if current_template in templates:
            ...
            # Templates with "lang="
                ...
                if 'lang=' not in page_content2 or page_content2.find('lang=') > page_content2.find('}}'):
            ...
            elif fix_translations and current_template in translation_templates_with_language_at_first:
                ...
                page_content, final_page_content, summary, infinitive = treat_verb_inflexion(

...
def modification(PageHS):
	...
	if page.exists():
		if page.namespace() != 0 and page.title() != u'Utilisateur:JackBot/test': 
			...
			if PageHS.find(u'/') != -1: page.delete(u'Suppression après gestion des pages liées', u'', throttle = True)	
...
python protect.py -lang:fr -family:wikiversity -file:"articles_list.txt" -edit:sysop -move:sysop -summary:"Protection des modèles > 10 000"
python delete.py -lang:fr -family:wikiversity -file:"articles_list.txt" -summary:
python movepages.py -lang:fr -family:wikiversity -pairs:"articles_listed.txt" -noredirect
python interwiki.py -lang:fr -family:wikiversity -page:"Utilisateur:JackBot"
python imagecopy.py -lang:fr -family:wikiversity -cat:
python revertbot.py -lang:fr -family:wikiversity

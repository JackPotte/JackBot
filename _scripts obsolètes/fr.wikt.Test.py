...
limit2 = 168 # Paragraphes sans modèle catégorisant, {{voir| et {{voir/ sont gérés individuellement
Modele[168] = u'supp'
Modele[169] = u'PàS'
...
Modele[203] = u'c'
Modele[204] = u'mf'
limit3 = 205 # Paragraphes sans modèle catégorisant pouvant contenir des modèles
...
def modification(PageHS):
	...
	if page.namespace() == 0 or PageHS == u'Utilisateur:JackBot/test':
		...
		if PageTemp.find(u'{{formater') != -1 or PageTemp.find(u'{{supp') != -1 or PageTemp.find(u'-erreur-') != -1:
		...
		if PageTemp.find(u'{{voir|') == -1 and PageTemp.find(u'{{voir/') == -1:
			...
			if PagesCleTotal.find(CleDeTri(PageHS)) == -1: PagesCleTotal = PagesCleTotal + u'|' + CleDeTri(PageHS)	# exception ? and PageTemp.find(u'{{langue|eo}}') == -1
...
def CleDeTri(PageTitre):
	...
	for lettre in range(0,len(PageTitre)):
		...
		if PageTitre[lettre:lettre+1] == u'à' or PageTitre[lettre:lettre+1] == u'Á' or PageTitre[lettre:lettre+1] == u'á' or PageTitre[lettre:lettre+1] == u'â' or PageTitre[lettre:lettre+1] == u'ä' or PageTitre[lettre:lettre+1] == u'ā' or PageTitre[lettre:lettre+1] == u'ă' or PageTitre[lettre:lettre+1] == u'ą' or PageTitre[lettre:lettre+1] == u'ǎ' or PageTitre[lettre:lettre+1] == u'ǻ' or PageTitre[lettre:lettre+1] == u'ȁ' or PageTitre[lettre:lettre+1] == u'ȃ' or PageTitre[lettre:lettre+1] == u'ȧ' or PageTitre[lettre:lettre+1] == u'ɑ' or PageTitre[lettre:lettre+1] == u'ạ' or PageTitre[lettre:lettre+1] == u'ả' or PageTitre[lettre:lettre+1] == u'ấ' or PageTitre[lettre:lettre+1] == u'Ấ' or PageTitre[lettre:lettre+1] == u'ⱥ' or PageTitre[lettre:lettre+1] == u'À' or PageTitre[lettre:lettre+1] == u'Â' or PageTitre[lettre:lettre+1] == u'Ä' or PageTitre[lettre:lettre+1] == u'Å' or PageTitre[lettre:lettre+1] == u'Ā' or PageTitre[lettre:lettre+1] == u'Ă' or PageTitre[lettre:lettre+1] == u'Ą' or PageTitre[lettre:lettre+1] == u'Ǎ' or PageTitre[lettre:lettre+1] == u'Ǻ' or PageTitre[lettre:lettre+1] == u'Ȁ' or PageTitre[lettre:lettre+1] == u'Ȃ' or PageTitre[lettre:lettre+1] == u'Ȧ' or PageTitre[lettre:lettre+1] == u'Ⱥ' or PageTitre[lettre:lettre+1] == u'Ɑ' or PageTitre[lettre:lettre+1] == u'Ǟ' or PageTitre[lettre:lettre+1] == u'Ǡ' or PageTitre[lettre:lettre+1] == u'ắ' or PageTitre[lettre:lettre+1] == u'Ắ' or PageTitre[lettre:lettre+1] == u'å' or PageTitre[lettre:lettre+1] == u'Å':
			...
			PageT = PageT + "k"
			key = "yes"
		elif PageTitre[lettre:lettre+1] == u'ĺ' or PageTitre[lettre:lettre+1] == u'ļ' or PageTitre[lettre:lettre+1] == u'ľ' or PageTitre[lettre:lettre+1] == u'ŀ' or PageTitre[lettre:lettre+1] == u'ł' or PageTitre[lettre:lettre+1] == u'ƚ' or PageTitre[lettre:lettre+1] == u'ȴ' or PageTitre[lettre:lettre+1] == u'ɫ' or PageTitre[lettre:lettre+1] == u'Ɫ' or PageTitre[lettre:lettre+1] == u'Ĺ' or PageTitre[lettre:lettre+1] == u'Ļ' or PageTitre[lettre:lettre+1] == u'Ľ' or PageTitre[lettre:lettre+1] == u'Ŀ' or PageTitre[lettre:lettre+1] == u'Ł' or PageTitre[lettre:lettre+1] == u'Ƚ' or PageTitre[lettre:lettre+1] == u'ǉ' or PageTitre[lettre:lettre+1] == u'Ǉ' or PageTitre[lettre:lettre+1] == u'ǈ' or PageTitre[lettre:lettre+1] == u'ị' or PageTitre[lettre:lettre+1] == u'Ị' or PageTitre[lettre:lettre+1] == u'í' or PageTitre[lettre:lettre+1] == u'Í':
			PageT = PageT + "l"
			key = "yes"
...
# Lancement
TraitementPage = modification(u'rouler sur l’or')
TraitementPage = modification(u'battre l’eau avec un bâton')
'''
# Quotidiennement :
...
'''
#TraitementCategorie = crawlerCat(u'Catégorie:slovène',False, u'jamborom')
# trad calabrais
# https://fr.wiktionary.org/w/index.php?title=Kilometer&diff=14733143&oldid=14605865
...
#TraitementPage = modification(u'en')
#TraitementCategorie = crawlerCat(u'Catégorie:Satellites en français')
#TraitementPage = modification(u'vomir')
#TraitementLiens = crawlerLink(u'Modèle:SAMPA',u'')
# Synchroniser les phonèmes dans les vides des pluriels
# pb des clés tri en lecture fichier ASCII (renvoie & + ... + ;)
# Trier {{trad|cat|}}
# ajouter les anagrammes à accents, ex : bâton, nabot
# créer lemmes des pluriels en anglais avec {{ébauche-déf|en}}

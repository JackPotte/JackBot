...
__version__ = '$Id: 4d25b430fece23e11c8c9d25daf13f84397f8719 $'
...
class Family(family.WikimediaFamily):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'mk', 'new', 'be', 'pms', 'tl', 'ta', 'ht', 'te', 'tt', 'cy',
            'be-x-old', 'lv', 'sq', 'bs', 'br', 'jv', 'mg', 'mr', 'lb', 'is',
            'ml', 'my', 'ba', 'yo', 'an', 'lmo', 'fy', 'af', 'bn', 'pnb', 'sw',
            'zh-yue', 'bpy', 'io', 'ur', 'ky', 'ne', 'scn', 'gu', 'ga', 'nds',
            'ku', 'cv', 'ast', 'qu', 'su', 'sco', 'als', 'ia', 'bug', 'nap',
            'kn', 'bat-smg', 'map-bms', 'wa', 'am', 'ckb', 'gd', 'tg', 'hif',
            'zh-min-nan', 'arz', 'mzn', 'yi', 'mn', 'vec', 'sah', 'nah', 'sa',
            'roa-tara', 'os', 'si', 'bar', 'pam', 'hsb', 'se', 'pa', 'li', 'mi',
            'co', 'fo', 'ilo', 'gan', 'bo', 'glk', 'frr', 'rue', 'bcl',
            'nds-nl', 'fiu-vro', 'mrj', 'tk', 'ps', 'vls', 'xmf', 'gv', 'min',
            'or', 'diq', 'kv', 'pag', 'km', 'zea', 'mhr', 'dv', 'csb', 'ce',
            'nrm', 'vep', 'rm', 'koi', 'udm', 'lad', 'lij', 'wuu',
            'zh-classical', 'fur', 'sc', 'hak', 'stq', 'mt', 'ug', 'ay', 'so',
            'pi', 'bh', 'ksh', 'nov', 'kw', 'gn', 'ang', 'pcd', 'nv', 'as',
            'ext', 'gag', 'eml', 'frp', 'ace', 'szl', 'ie', 'ln', 'pfl', 'krc',
            'xal', 'haw', 'pdc', 'rw', 'crh', 'lez', 'dsb', 'to', 'arc', 'kl',
            'myv', 'kab', 'sn', 'bjn', 'pap', 'tpi', 'lbe', 'wo', 'mwl', 'jbo',
            'mdf', 'lo', 'kbd', 'cbk-zam', 'av', 'srn', 'ty', 'kg', 'ab', 'tet',
            'ltg', 'ig', 'na', 'bxr', 'nso', 'za', 'kaa', 'zu', 'chy', 'rmy',
            'cu', 'tn', 'chr', 'cdo', 'roa-rup', 'bi', 'got', 'sm', 'bm', 'iu',
